'Section 2: \\(\\sigma(f_{\\rm NL})\\) vs \\(\\ell_{\\max}\\) up to 1000.'
...
def main():
    ...
    ap.add_argument(
        ...
        help="Comma-separated f_NL fiducials for marg_ns curves.",
    )
    ap.add_argument(
        "--include-cv-csv",
        action="store_true",
    ...
    ap.add_argument(
        ...
        choices=("png", "pdf"),
        default="png",
        help="Figure format for the standard Section 2 plots (default: png).",
    )
    args = ap.parse_args()
    ...
    for fnl in fnl_fids:
        ...
        ax.set_title(
            rf"Section 2 ({args.experiment.upper()}): $n_s$ marginalization; "
